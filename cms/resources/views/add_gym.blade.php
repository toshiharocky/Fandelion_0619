				...
				<div id="add-listing">
					<form method='POST' action={{ 'gym_register' }} enctype="multipart/form-data">
						...
						<div class="add-listing-section margin-top-45">
							...
							<div class="form">
								<h5>ジムの説明</h5>
								<input name="gym_desc" class="WYSIWYG" name="summary" cols="40" rows="3" spellcheck="true"></textarea>
							</div>
						...
						<input type="submit" class="button preview">Preview <i class="fa fa-arrow-circle-right"></i></input>
					</form>
				</div>
